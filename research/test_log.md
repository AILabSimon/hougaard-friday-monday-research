...
| HF-021 | E1 — short at Friday close, TP Friday low, SL Friday high | Confirmatory | COMPLETE | 41.1% TP / 48.8% SL; median R available only 0.75. Expectancy ≈ 0 and driven by outliers. | `results/strategy_expectancy.csv` |
| HF-022 | E2 — short at Monday open, TP Friday low, SL Friday high | Confirmatory | COMPLETE | Mean R = −0.115 (US idx RTH). Negative. | `results/strategy_expectancy.csv` |
| HF-023 | E3 — short at Monday open, fixed ATR stop / 1–3R target | Confirmatory | COMPLETE | Mean R = −0.03 to −0.10 triggered; −0.10 to −0.18 non-triggered. All negative before costs. | `results/strategy_expectancy.csv`, `charts/07` |
...
| HF-026 | Is the US-index residual monetisable in a non-directional form? | Exploratory | **NOT STARTED** | — | — |
